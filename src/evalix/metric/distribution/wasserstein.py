...
from evalix.metric.utils import contains_nan, preprocess_same_shape_arrays
from evalix.utils.imports import check_scipy, is_scipy_available
...
def wasserstein_distance(
    ...
    *,
    ...
    >>> import numpy as np
    >>> from evalix.metric import wasserstein_distance
