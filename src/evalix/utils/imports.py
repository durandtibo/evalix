...
def is_colorlog_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_colorlog_available
    >>> is_colorlog_available()
...
def check_colorlog() -> None:
    ...
    >>> from evalix.utils.imports import check_colorlog
    >>> check_colorlog()
...
def colorlog_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import colorlog_available
    >>> @colorlog_available
...
def is_hya_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_hya_available
    >>> is_hya_available()
...
def check_hya() -> None:
    ...
    >>> from evalix.utils.imports import check_hya
    >>> check_hya()
...
def hya_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import hya_available
    >>> @hya_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def is_hydra_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_hydra_available
    >>> is_hydra_available()
...
def check_hydra() -> None:
    ...
    >>> from evalix.utils.imports import check_hydra
    >>> check_hydra()
...
def hydra_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import hydra_available
    >>> @hydra_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def is_markdown_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_markdown_available
    >>> is_markdown_available()
...
def check_markdown() -> None:
    ...
    >>> from evalix.utils.imports import check_markdown
    >>> check_markdown()
...
def markdown_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import markdown_available
    >>> @markdown_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def is_matplotlib_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_matplotlib_available
    >>> is_matplotlib_available()
...
def check_matplotlib() -> None:
    ...
    >>> from evalix.utils.imports import check_matplotlib
    >>> check_matplotlib()
...
def matplotlib_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import matplotlib_available
    >>> @matplotlib_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def check_objectory() -> None:
    ...
    >>> from evalix.utils.imports import check_objectory
    >>> check_objectory()
...
def objectory_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import objectory_available
    >>> @objectory_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def is_omegaconf_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_omegaconf_available
    >>> is_omegaconf_available()
...
def check_omegaconf() -> None:
    ...
    >>> from evalix.utils.imports import check_omegaconf
    >>> check_omegaconf()
...
def omegaconf_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import omegaconf_available
    >>> @omegaconf_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
...
def is_scipy_available() -> bool:
    ...
    >>> from evalix.utils.imports import is_scipy_available
    >>> is_scipy_available()
...
def check_scipy() -> None:
    ...
    >>> from evalix.utils.imports import check_scipy
    >>> check_scipy()
...
def scipy_available(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    >>> from evalix.utils.imports import scipy_available
    >>> @scipy_available
    ... def my_function(n: int = 0) -> int:
    ...     return 42 + n
    ...
