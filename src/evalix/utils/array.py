...
__all__ = ["check_square_matrix", "filter_range", "nonnan", "rand_replace"]
...
def check_square_matrix(name: str, array: np.ndarray) -> None:
    ...
    >>> import numpy as np
    >>> from evalix.utils.array import check_square_matrix
...
def filter_range(array: np.ndarray, xmin: float, xmax: float) -> np.ndarray:
    ...
    >>> import numpy as np
    >>> from evalix.utils.array import filter_range
...
def rand_replace(
    ...
    >>> import numpy as np
    >>> from evalix.utils.array import rand_replace
