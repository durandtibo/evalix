...
def boxplot_continuous(
    ...
    >>> from evalix.plot import boxplot_continuous
    >>> fig, ax = plt.subplots()
...
def boxplot_continuous_temporal(
    ...
    >>> import numpy as np
    >>> from matplotlib import pyplot as plt
    >>> from evalix.plot import boxplot_continuous_temporal
    >>> fig, ax = plt.subplots()
...
def hist_continuous(
    ...
    >>> import numpy as np
    >>> from matplotlib import pyplot as plt
    >>> from evalix.plot import hist_continuous
    >>> fig, ax = plt.subplots()
...
def hist_continuous2(
    ...
    >>> import numpy as np
    >>> from matplotlib import pyplot as plt
    >>> from evalix.plot import hist_continuous2
    >>> fig, ax = plt.subplots()
