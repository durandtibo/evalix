...
from evalix.plot.utils import auto_yscale_discrete, readable_xticklabels
...
def bar_discrete(
    ...
    >>> from matplotlib import pyplot as plt
    >>> from evalix.plot import bar_discrete
    >>> fig, ax = plt.subplots()
...
def bar_discrete_temporal(
    ...
    >>> from matplotlib import pyplot as plt
    >>> from evalix.plot import bar_discrete_temporal
    >>> fig, ax = plt.subplots()
